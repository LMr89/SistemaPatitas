...
INSERT INTO `cita` VALUES (18,1,5,1,1,'2022-07-17 10:29:26','2022-07-17 11:29:00',1),(19,1,5,1,1,'2022-07-17 09:24:12','2022-07-30 11:23:00',1),(20,1,5,1,1,'2022-07-17 09:56:55','2022-07-19 02:56:00',1),(21,1,5,1,1,'2022-07-17 09:57:55','2022-07-23 02:57:00',1),(23,24,2,1,1,'2022-07-17 10:10:20','2022-07-26 04:10:00',1),(24,1,5,2,1,'2022-07-17 10:40:42','2022-07-21 01:40:00',1),(25,8,4,2,1,'2022-07-17 10:44:44','2022-07-21 01:00:00',1);
...
CREATE TABLE `horario` (
  ...
  KEY `Horario_FK` (`id_veterinario`),
  CONSTRAINT `Horario_FK` FOREIGN KEY (`id_veterinario`) REFERENCES `veterinario` (`id_veterinario`)
...
INSERT INTO `horario` VALUES (1,1,'08:00:00','12:00:00'),(2,1,'14:00:00','17:30:00'),(3,2,'08:00:00','14:00:00'),(4,2,'16:30:00','17:30:00');
...
INSERT INTO `mascota` VALUES (1,16,'Roger',3,'Negro',1,1),(2,24,'Gruño',2,'Marron',1,1),(4,8,'Godines',4,'Gris',1,1),(5,1,'Firu',2,'Marron',1,1);
...
INSERT INTO `veterinario` VALUES (1,1),(2,2);
...
BEGIN	
		...
		SET nombreusuario = nmUsuario,contrase�ausuario  = cnUsurio,
...
BEGIN	
	SELECT idperfilusuario, nombreusuario , contrase�ausuario
	FROM perfil_usuario
